...
fitStan = stan_mvmer(
                     formula = list(
                                    scores.1 ~ cog_load + cog_load:syllable1 + cog_load:syllable2 + syllable1 + syllable2 + syllable1:syllable2 + (1|subject),
                                    scores.2 ~ cog_load + cog_load:syllable1 + cog_load:syllable2 + syllable1 + syllable2 + syllable1:syllable2 + (1|subject),
                                    scores.3 ~ cog_load + cog_load:syllable1 + cog_load:syllable2 + syllable1 + syllable2 + syllable1:syllable2 + (1|subject)
                                    ),
                     data = data_stan,
                     chains = min(4, cores),
                     cores = min(4, cores)
