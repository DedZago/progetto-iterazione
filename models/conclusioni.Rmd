...
plot_posterior = function(post_fpca, ndraws = 300, fixed = "both"){
    ...
    if(fixed == "both"){
        ...
        matplot(t(scostamento)[1:10, ], type = "l", main = paste0("Scostamento ", post_fpca$syllable1, " dovuto a ", post_fpca$syllable1, ":", post_fpca$syllable2))
        par(mfrow = c(1,1))
    } else{
        par(mfrow = c(2, 1))
        matplot(11:20, t(baseline)[11:20, ], type = "l", main = paste0("Baseline ", post_fpca$ref))
        matplot(11:20, t(scostamento)[11:20, ], type = "l", main = paste0("Scostamento ", post_fpca$syllable2, " dovuto a ", post_fpca$syllable1, ":", post_fpca$syllable2))
        par(mfrow = c(1,1))
    }
}
```
