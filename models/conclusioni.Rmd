...
```{r}
scostamento1 <- cbind(get_posterior(posterior, fpca, "T1", "T3", fixed = "first")$scostamento[,1:10],
                     get_posterior(posterior, fpca, "T3", "T1", fixed = "second")$scostamento[,11:20])

scostamento2 <- cbind(get_posterior(posterior, fpca, "T1", "T3", fixed = "first")$scostamento[,1:10],
                     get_posterior(posterior, fpca, "T4", "T1", fixed = "second")$scostamento[,11:20])


png("mediazione.png", 2000, 1200, res = 150)
par(mfrow = c(1,2))
matplot(t(scostamento1), type = "l", col = "grey")
lines(rowMeans(t(scostamento1)), col = 2, lwd = 2)
matplot(t(scostamento2), type = "l", col = "grey")
lines(rowMeans(t(scostamento2)), col = 2, lwd = 2)
```
