...
plot_posterior = function(post_fpca, ndraws = 300, fixed = "both"){
    ...
    if(fixed == "both"){
        ...
        matplot(t(scostamento)[1:10, ], type = "l", main = paste0("Scostamento ", post_fpca$syllable1, " dovuto a ", post_fpca$syllable1, ":", post_fpca$syllable2), col = "grey")
        lines(rowMeans(t(scostamento))[1:10])
        par(mfrow = c(1,1))
    } else{
        par(mfrow = c(2, 1))
        ...
        lines(11:20, rowMeans(t(scostamento))[11:20])
        par(mfrow = c(1,1))
    }
}
```
