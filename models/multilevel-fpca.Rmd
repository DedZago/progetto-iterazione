...
#parametri da regolare: tol_rel_obj (default 0.01), iter (default 10000), elbo_samples (default 100), grad_samples (default 1)
...
fitStanLmerFpca1 = stan_glmer(f0 ~ cog_load + current + peak + syllable1 + syllable2 + syllable1:syllable2 +
                              ...
                              ,
                         data = mandarino_fpca,
                    #algorithm = "meanfield", tol_rel_obj = 0.00001, elbo_samples = 10000, grad_samples = 10,
                    iter = 2000,
                    QR = TRUE)
