...
rbind(cbind(mean(unlist(kf1)),  sd(unlist(kf1))),
    ...
    set_rownames(c("No eff. casuali di interazione", "Eff. casuali interazione", "Eff. casuali interazione no cog_load", "Eff. casuali interazione no cog_load no current")) %>%
