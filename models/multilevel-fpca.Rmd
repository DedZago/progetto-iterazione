...
fpca = FPCA(Ly = Y_list, Lt = t_list, optns = list(FVEthreshold = 0.99))
...
K = fpca$selectK
eigenFPCA = fpca$phi                                 # Estimated eigenfunctions
...
```{r stan_lme_ppc}
plot(fitStanLmer2, pars=names(fitStanLmer2$coefficients)[1:33])
```
